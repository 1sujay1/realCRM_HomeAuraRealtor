...
export default function Drawer({ isOpen, onClose, title, children }: any) {
  return (
    <>
      ...
      <div className={cn("fixed top-0 mt-0 right-0 h-screen z-[60] w-full max-w-md bg-white shadow-2xl transform transition-transform duration-300 ease-in-out", isOpen ? "translate-x-0" : "translate-x-full")}>
